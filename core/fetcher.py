...
from config import FEED_BASE_URL, SEARCH_QUERIES
...
def fetch_all_jobs() -> list[dict]:
    ...
    try:
        from core.technopark_fetcher import fetch_technopark_jobs
    ...
    try:
        from core.cutshort_fetcher import fetch_cutshort_jobs
