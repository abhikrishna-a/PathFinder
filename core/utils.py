...
def is_company_email(email: str) -> tuple:
    """
    Validates whether an email is likely a real company email (not personal/free provider).
...
def safe(text: str) -> str:
    """Make text safe for Windows console output (replace problematic chars)."""
    try:
