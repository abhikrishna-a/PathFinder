...
def overview(request):
    ...
    stats_history = list(DailyStats.objects.order_by("-date")[:14])
...
def job_list(request):
    ...
    valid_sorts = ["-match_score", "match_score", "-fetched_date", "company", "title"]
...
def profile_view(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            # Parse projects from JSON string if needed
            ...
            # Parse looking_for from comma-separated string
            ...
            # Convert experience fields to int
